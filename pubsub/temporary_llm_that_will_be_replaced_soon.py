...
llm = LLM
PROMPT_TEMPLATE = """You are a research assistant. Given the following list of paper matadata including abstracts, select the top {k} that are most relevant to the following user project description: "{topic}"
