...
class TestTimeouts:
    """Centralized timeout configuration for E2E tests."""
    PROJECT_CREATION = 90000  # 90 seconds for LLM processing
    PAPER_LOAD = 90000  # 90 seconds for paper loading
    SSE_STREAM = 90000  # For SSE event streams
    LOAD_MORE = 90000  # For load more button
    REPLACEMENT = 15000  # For paper replacement
    DEFAULT = 10000  # Default wait timeout

@pytest.fixture(scope="session", autouse=True)
def enable_test_mode():
    """
    Enable TEST_MODE for cost optimization in E2E tests.
    
    This switches the LLM to GPT-4o-mini (~98% cheaper than GPT-4.1):
    - Production: GPT-4.1 (~$0.007/prompt)
    - Tests: GPT-4o-mini (~$0.0001/prompt)
...
def shared_project(flask_server):
    ...
    with sync_playwright() as p:
        ...
        page.fill("#projectDescription", "machine learning artificial intelligence neural networks deep learning computer vision")
